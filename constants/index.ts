...
const COMMON_LINKS: NavigationLink[] = [
  { text: "Quizzes", path: "quizzes", id: uuid() },
  { text: "Stories", path: "stories", id: uuid() },
  { text: "About us", path: "aboutUs", id: uuid() },
];

export const AUTHORIZED_LINKS: NavigationLink[] = [
  ...COMMON_LINKS,
  { text: "Profile", path: "profile", id: uuid() },
  { text: "Sign out", path: "", id: uuid() },
];
export const NON_AUTHORIZED_LINKS: NavigationLink[] = [
  ...COMMON_LINKS,
  { text: "Login", path: "", id: uuid() },
  { text: "Register", path: "", id: uuid() },
];
...
export const FORM_ERROR_MESSAGE_FUNCTIONS: FormErrorMessageFunction = {
  maxLength: (length: string) =>
    `Field has to contain maximum ${length} characters`,
};
...
export const POSTS: PostData[] = [
  {
    ...
    topic: "Education",
    description:
      "Online Quizzes vs. Traditional Tests: Which is Better for Learning?",
    content: [
      {
      ...
      {
        text: [
          "Accessibility: Online quizzes can be taken from anywhere with an internet connection, making them accessible to remote learners and those with busy schedules.",
          "Immediate Feedback: With automatic grading, students receive instant feedback, enabling them to learn from their mistakes right away.",
          "Engagement: Incorporating multimedia elements like videos and interactive questions can enhance engagement and cater to various learning styles.",
          "Data Tracking: Educators can easily collect and analyze data on student performance to tailor instruction and interventions.",
        ],
        type: "ordered",
      },
      {
      ...
      {
        text: [
          "Security Concerns: Online quizzes can be susceptible to cheating and academic dishonesty if not carefully monitored.",
          "Technical Issues: Students may encounter technical problems, such as internet connectivity issues or software glitches, disrupting the assessment process.",
        ],
        type: "ordered",
      },
      {
      ...
      {
        text: [
          "Familiarity: Traditional tests have been used for generations, and students are generally familiar with the format.",
          "Security: It can be easier to prevent cheating during in-person exams with proper proctoring.",
          "No Technical Hurdles: There are no technology-related issues to contend with, ensuring a smoother testing experience.",
        ],
        type: "ordered",
      },
      {
      ...
      {
        text: [
          "Limited Feedback: Grading traditional tests can be time-consuming, leading to delayed feedback for students.",
          "Stress: High-stakes traditional tests can induce test anxiety, potentially hindering performance.",
        ],
        type: "ordered",
      },
      {
      ...
      {
        text: [
          "Course Objectives: Consider your learning goals. Online quizzes might be more suitable for formative assessment and frequent knowledge checks, while traditional tests may be preferred for summative assessments.",
          "Student Preferences: Survey your students to understand their preferences and comfort levels with technology.",
          "Time and Resources: Assess your available time, resources, and technical capabilities for delivering assessments.",
        ],
        type: "unordered",
      },
      {
    ...
    author: {
      name: "Nikola Tafra",
      about:
        "By day, a serious PHP developer. By night, also weird. Still struggles to accept defeat in Croatian TV show “Chase” last year.",
    },
    date: "19/07/2023",
  },
  {
    ...
    topic: "Education",
    description:
      "Gamification in Education: Using Quizzes to Make Learning Fun",
    content: [
      {
      ...
      {
        text: [
          "Increased Engagement: Gamified quizzes pique students' interest, making them more eager to participate and learn.",
          "Motivation: The promise of rewards, points, or badges can motivate students to actively engage with the material.",
          "Sense of Progress: Gamification often includes progress tracking, giving students a sense of accomplishment as they move through the course.",
          "Competition and Collaboration: Leaderboards and team challenges foster healthy competition and encourage collaboration among students.",
        ],
        type: "ordered",
      },
      {
      ...
      {
        text: [
          "Ensure that the gamification elements align with the learning objectives and content.",
          "Keep the game elements challenging but not overwhelming to prevent frustration.",
          "Encourage reflection after gamified quizzes to connect the experience to deeper learning.",
        ],
        type: "unordered",
      },
      {
  ...
  },
  {
    ...
    topic: "Education",
    description:
      "Unlocking Learning Potential: The Quiz-Based Pedagogical Renaissance",
    content: [
      {
  ...
  },
  {
    ...
    topic: "Education",
    description:
      "The Psychology of Quiz-Taking: How to Help Students Overcome Test Anxiety",
    content: [
      {
  ...
  },
  {
    ...
    topic: "Education",
    description:
      "How to Create Engaging and Effective Quizzes for Online Courses",
    content: [
      {
...
export const FEATURED_POST: PostData = {
  ...
  date: "19/07/2023",
  description:
    "Quizzes are back, and they don't intend to go away anytime soon!",
  topic: "Quiz Speak",
...
export const BIOLOGY_QUIZZES: QuizData[] = [
  ...
  },
  {
    ...
    subtitle:
      "Look up in the sky, it's a bird, it's a plane... it's a quiz about birds and insects!",
    date: "02/03/2023",
  },
  {
...
export const ART_QUIZZES: QuizData[] = [
  ...
  },
  {
    ...
    subtitle:
      "Claude Mona and Lisa Simpson are two of the most famous artists in the world, right?",
    date: "06/07/2023",
  },
  {
...
export const TECHNOLOGY_QUIZZES: QuizData[] = [
  ...
  },
  {
    ...
    subtitle:
      "Why don't we have just one programming language? Wouldn't that be easier?",
    date: "01/01/2023",
  },
  {
    ...
    title: "Spaceships",
    subtitle:
      "I think we can land on the Sun, but only at night so we don't burn.",
    date: "05/05/2023",
  },
  {
...
export const SPORT_QUIZZES: QuizData[] = [
  ...
  },
  {
    ...
    subtitle:
      "Why is it called Premier League if it's not the best league in the world? Are others Secondier Leagues?",
    date: "12/12/2022",
  },
  {
...
export const GENERAL_QUIZZES: QuizData[] = [
  ...
  },
  {
    ...
    subtitle:
      "Best Buzzfeed quiz about Buzzfeed - what else could you possibly need?!",
    date: "01/10/2022",
  },
  {
    ...
    subtitle:
      "Finally, you can use that knowledge about the number of teeth in a shark's mouth!",
    date: "12/12/2022",
  },
  {
...
export const HOME_PAGE_TOPICS: Topic[] = [
  ...
  },
  {
    id: uuid(),
    name: "Compete",
    text: "Prove Your Mastery of the Arcane Arts! Engage in Duels of Wit and Wisdom as You Compete Against Other Spellcasters. Rise Through the Ranks, Earn Prestigious Titles, and Write Your Name Into the Mystical Scrolls of Qwizardry.",
  },
  {
    id: uuid(),
    name: "Learn",
