    ...
    return (
        <Flex px={COMMON_PAGE_PADDING} justify="space-between" pb="76px" direction={{ base: "column", md: "row" }} w="100%">
            <Flex justifyContent={{ base: "center", md: "flex-end" }} alignItems="center" w={{ base: "100%", md: "50%" }} pr={{ base: "0px", md: "15px" }} pb={{ base: "15px", md: "0px" }}>
                <Button visibility={currentPage > 1 ? "visible" : "hidden"} text="Previous Page" buttonAction={handlePageDecrease} key="Left pagination button" backgroundColor="blue" backgroundColorOnClick="blueOnClick" textColor="white" />
            </Flex>
            <Flex justifyContent="space-between" alignItems="center" w={{ base: "100%", md: "50%" }} pl={{ base: "0px", md: "15px" }} direction={{ base: "column", md: "row" }} gap={{ base: "15px", md: "0px" }}>
                <Button visibility={currentPage < numberOfPages ? "visible" : "hidden"} text="Next Page" buttonAction={handlePageIncrease} key="Right pagination button" backgroundColor="blue" backgroundColorOnClick="blueOnClick" textColor="white" />
                <Center gap="5px">
